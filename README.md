...
**AdsRepo** is a Swift base library for managing and loading different ad units simultaneously and controlling all of them under repository options and functions. the repository will load ads and keep them fresh base on develoepr-specific conditions and you only communicate with the repository to get ads.
...
- [Usage/Examples](#usage/examples)
  ...
  -  [Custom AdLoader (optional)](#custom-adLoader)
  -  [Custom AdWrapper (optional)](#custom-adWrapper)
  -  [Custom Error handler (optional)](#custom-error-handler)
  -  [Custom network reachability (optional)](#custom-network-reachability)
- [Run tests](#run-tests)
- [FAQ](#faq)
- [Authors](#authors)
...
For create your custom ad loader you have to follow this protocol:
...
For create your custom ad wrapper you have to follow this protocol:
...
### Customize network reachability

If the network goes offline or comes back online repository uses the object to implement `AdRepositoryReachabilityPorotocol` to handle the issue (wait or start request for ads) which you can also implement by following the below protocol and set to your repository.
...
To run tests, go to **Edit scheme** and from **Test** in tab **Info** press on **+** to add a new test target. and also you require **Quick** and **Nimble** libraries to run tests which will install if install pod with tests.
