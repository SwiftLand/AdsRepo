//
//  RewardedAdRepositoryProtocol.swift
//  AdsRepo
//
...
public protocol RewardedAdRepositoryProtocol:AdsRepoProtocol{
    ...
    func presentAd(vc:UIViewController,willLoad:((RewardedAdWrapper?)->Void)?)->Bool
